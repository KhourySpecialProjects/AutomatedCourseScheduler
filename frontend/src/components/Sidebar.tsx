...
const NAV_ITEMS = [
  ...
  { to: '/admins', label: 'Admins', icon: <ShieldIcon />, adminOnly: true },
];
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo row */}
      <div
        className={`flex h-24 border-b border-gray-100 ${collapsed ? 'px-3' : 'px-0'}`}
      >
        <div
          className={`w-full h-full pt-3 ${collapsed ? 'flex justify-start' : ''}`}
        >
          <img
            src="/acs-logo.png"
