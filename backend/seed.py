...
def seed(db: Session) -> None:
    ...
    courses = [
        ...
        Course(course_id=7, subject="CS", code=1800, name="Discrete Structures",
               description="", credits=4, priority=True),
        ...
        Course(course_id=165, subject="CY", code=2550,
               name="Foundations of Cybersecurity", description="", credits=4, priority=True),
        ...
        Course(course_id=204, subject="DS", code=3000,
               name="Foundations of Data Science", description="", credits=4, priority=True),
        ...
        Course(course_id=208, subject="DS", code=4400,
               name="Machine Learning and Data Mining 1", description="", credits=4, priority=True),
    ...
    assignments = [
        ...
        FacultyAssignment(
            faculty_nuid=58,  section_id=sections[13].section_id),
        # Wand → CS 2800 Logic and CS 5002 Discrete Structures
        FacultyAssignment(faculty_nuid=824,
                          section_id=sections[14].section_id),
        FacultyAssignment(faculty_nuid=824,
                          section_id=sections[15].section_id),
        # Tip → CS 5004 OOD and CS 4530 SE
        FacultyAssignment(faculty_nuid=769,
                          section_id=sections[22].section_id),
        FacultyAssignment(faculty_nuid=769,
                          section_id=sections[25].section_id),
        # Derbinsky → CS 5008 Data Structures
        FacultyAssignment(faculty_nuid=177,
                          section_id=sections[24].section_id),
        ...
        FacultyAssignment(faculty_nuid=824,
                          section_id=sections[27].section_id),
    ]
    ...
    preferences = [
        ...
        CoursePreference(faculty_nuid=227, course_id=69,
                         preference=PreferenceLevel.EAGER),    # CS 5001
        CoursePreference(faculty_nuid=227, course_id=70,
                         preference=PreferenceLevel.WILLING),  # CS 5002
        CoursePreference(faculty_nuid=227, course_id=15,
                         preference=PreferenceLevel.WILLING),  # CS 2500
        # Cohen — theory / algorithms
        CoursePreference(faculty_nuid=141, course_id=34,
                         preference=PreferenceLevel.EAGER),    # CS 3800 Theory
        CoursePreference(faculty_nuid=141, course_id=21,
                         preference=PreferenceLevel.EAGER),    # CS 3000 Algorithms
        CoursePreference(faculty_nuid=141, course_id=102,
                         preference=PreferenceLevel.WILLING),  # CS 5800 Algorithms
        # Barzilay — discrete math / logic
        CoursePreference(faculty_nuid=58, course_id=7,
                         preference=PreferenceLevel.EAGER),     # CS 1800 Discrete
        CoursePreference(faculty_nuid=58, course_id=18,
                         preference=PreferenceLevel.WILLING),   # CS 2800 Logic
        # Wand — logic / PL / programming paradigms
        CoursePreference(faculty_nuid=824, course_id=18,
                         preference=PreferenceLevel.EAGER),    # CS 2800 Logic
        CoursePreference(faculty_nuid=824, course_id=70,
                         preference=PreferenceLevel.EAGER),    # CS 5002 Discrete
        CoursePreference(faculty_nuid=824, course_id=48,
                         preference=PreferenceLevel.EAGER),    # CS 4400 PL
        CoursePreference(faculty_nuid=824, course_id=78,
                         preference=PreferenceLevel.WILLING),  # CS 5010 Prog Paradigm
        # Tip — software engineering / PL
        CoursePreference(faculty_nuid=769, course_id=72,
                         preference=PreferenceLevel.EAGER),    # CS 5004 OOD
        CoursePreference(faculty_nuid=769, course_id=52,
                         preference=PreferenceLevel.EAGER),    # CS 4530 SE
        CoursePreference(faculty_nuid=769, course_id=50,
                         preference=PreferenceLevel.WILLING),  # CS 4500 SW Dev
        # Choffnes — networks
        CoursePreference(faculty_nuid=131, course_id=33,
                         preference=PreferenceLevel.EAGER),   # CS 3700 Networks
        CoursePreference(faculty_nuid=131, course_id=57,
                         preference=PreferenceLevel.WILLING),  # CS 4700 Network Fund
        CoursePreference(faculty_nuid=131, course_id=101,
                         preference=PreferenceLevel.WILLING),  # CS 5700 Networking
        # Kirda — security
        CoursePreference(faculty_nuid=391, course_id=166,
                         preference=PreferenceLevel.EAGER),   # CY 3740 Sys Security
        CoursePreference(faculty_nuid=391, course_id=169,
                         preference=PreferenceLevel.EAGER),   # CY 4740 Net Security
        CoursePreference(faculty_nuid=391, course_id=32,
                         preference=PreferenceLevel.WILLING),  # CS 3650 Comp Systems
        # Derbinsky — systems / data structures
        CoursePreference(faculty_nuid=177, course_id=76,
                         preference=PreferenceLevel.EAGER),    # CS 5008 Data Struct
        CoursePreference(faculty_nuid=177, course_id=32,
                         preference=PreferenceLevel.WILLING),  # CS 3650 Comp Systems
    ]
    ...
    meeting_prefs = [
        ...
        MeetingPreference(
            # M 9:15
            faculty_nuid=227, meeting_time=time_blocks[5].time_block_id,  preference=PreferenceLevel.EAGER),
        MeetingPreference(
            # M 13:00
            faculty_nuid=227, meeting_time=time_blocks[11].time_block_id, preference=PreferenceLevel.WILLING),
        # Cohen — prefers midday
        MeetingPreference(
            # M 11:45
            faculty_nuid=141, meeting_time=time_blocks[9].time_block_id,  preference=PreferenceLevel.EAGER),
        # M 17:00 evening
        MeetingPreference(
            faculty_nuid=141, meeting_time=time_blocks[19].time_block_id, preference=PreferenceLevel.NOT_INTERESTED),
        # Barzilay — flexible mornings
        MeetingPreference(
            # M 9:15
            faculty_nuid=58,  meeting_time=time_blocks[5].time_block_id,  preference=PreferenceLevel.EAGER),
        MeetingPreference(
            # M 10:30
            faculty_nuid=58,  meeting_time=time_blocks[7].time_block_id,  preference=PreferenceLevel.WILLING),
        # Wand — mornings only
        MeetingPreference(
            # M 8:00
            faculty_nuid=824, meeting_time=time_blocks[2].time_block_id,  preference=PreferenceLevel.EAGER),
        MeetingPreference(
            # M 17:00
            faculty_nuid=824, meeting_time=time_blocks[19].time_block_id, preference=PreferenceLevel.NOT_INTERESTED),
        # Tip — afternoon preferred
        MeetingPreference(
            # M 13:00
            faculty_nuid=769, meeting_time=time_blocks[11].time_block_id, preference=PreferenceLevel.EAGER),
        MeetingPreference(
            # M 8:00
            faculty_nuid=769, meeting_time=time_blocks[2].time_block_id,  preference=PreferenceLevel.NOT_INTERESTED),
        # Choffnes — midday T/R
        MeetingPreference(
            # T 11:45
            faculty_nuid=131, meeting_time=time_blocks[0].time_block_id,  preference=PreferenceLevel.EAGER),
        MeetingPreference(
            # R 14:50
            faculty_nuid=131, meeting_time=time_blocks[1].time_block_id,  preference=PreferenceLevel.WILLING),
        # Kirda — flexible
        MeetingPreference(
            # M 11:45
            faculty_nuid=391, meeting_time=time_blocks[9].time_block_id,  preference=PreferenceLevel.WILLING),
        MeetingPreference(
            # M 14:50
            faculty_nuid=391, meeting_time=time_blocks[14].time_block_id, preference=PreferenceLevel.WILLING),
        # Derbinsky — mornings
        MeetingPreference(
            # M 9:15
            faculty_nuid=177, meeting_time=time_blocks[5].time_block_id,  preference=PreferenceLevel.EAGER),
        MeetingPreference(
            # M 18:00
            faculty_nuid=177, meeting_time=time_blocks[20].time_block_id, preference=PreferenceLevel.NOT_INTERESTED),
    ]
